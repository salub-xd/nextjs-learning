...
export default function Info() {
  const [task, setTask] = useState({ title: "", content: "", status: "none", userId: "653795e7b7cf5f5490533351" });
  ...
  const handleAddTask = async (e) => {
    ...
    try {
      ...
      setTask({ title: "", content: "", status: "none", userId: "653795e7b7cf5f5490533351" })
    } catch (error) {
      console.log(error);
